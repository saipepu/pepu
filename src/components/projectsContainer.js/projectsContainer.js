  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.canvas}>
        ...
        <a href="/pepu" target="_blank" rel="noopener" className={styles.labelContainer} onMouseOver={() => handleHover()} onMouseLeave={() => handleLeave()}>
        ...
        <a href="/pepu" target="_blank" rel="opener" className={styles.labelContainer} onMouseOver={() => handleHover()} onMouseLeave={() => handleLeave()}>
